...
class TestLogin:
    ...
    @staticmethod
    def test_try_to_login_from_lk_success_login(driver):
    ...
    def test_try_to_login_from_registration_form_success_login(driver):
        ...
        WebDriverWait(driver, 5).until(expected_conditions.text_to_be_present_in_element(LoginData.ALREADY_REGISTERED, 'Уже зарегистрированы? Войти'))
